...
from bot_first_aid.handlers.uchet_potreblenia_hadlers.uchet_potreblenia import uchet_potreblenia
...
def main():
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            CHOOSING: [
                ...
                CallbackQueryHandler(uchet_potreblenia, pattern='^uchet_potreblenia'),
    ...
    scheduler_kol_tablet.add_job(run_check_medicines, 'cron', hour='12-22', minute='*/10')
